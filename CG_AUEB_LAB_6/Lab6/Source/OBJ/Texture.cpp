...
void Texture::GenerateTexture()
{
    ...
    // the GL_TEXTURE_MIN_FILTER is the texture minification function and is used whenever one texel covers less than one pixel. For example a 32x32 texture showing in 128x128 area.
    // param can be:
    ...
    // the GL_TEXTURE_MAG_FILTER is the texture magnification function and is used whenever one texel covers more than one pixel. For example a 32x32 texture showing in a 8x8 area.
    // param can be:
    ...
    // border specifies the width of the border if we use GL_TEXTURE_BORDER in glTexParameter. We do not use this, so 0.
